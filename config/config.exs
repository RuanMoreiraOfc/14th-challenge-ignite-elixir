...
config :expi, ExpiWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: ExpiWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Expi.PubSub,
  live_view: [signing_salt: "2pUoWVga"]
...
config :expi, Expi.Mailer, adapter: Swoosh.Adapters.Local
